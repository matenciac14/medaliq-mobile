...
export default function NutritionScreen() {
    ...
    return (
      <View style={{ flex: 1, backgroundColor: '#f1f5f9' }}>
        ...
        >
          ...
          <View>
            <Text style={{ color: 'white', fontSize: 22, fontFamily: 'Inter_900Black', letterSpacing: -0.5 }}>Nutrición</Text>
            <Text style={{ color: 'rgba(255,255,255,0.6)', fontSize: 13, fontFamily: 'Inter_400Regular', marginTop: 2 }}>Plan personalizado según tu sesión</Text>
          </View>
        </LinearGradient>
  ...
  return (
    ...
    <ScrollView
      style={{ flex: 1 }}
      contentContainerStyle={{ paddingBottom: 32, paddingHorizontal: 20, paddingTop: 16, gap: 16 }}
            ...
            <View style={{ flexDirection: 'row', gap: 8 }}>
              {[
                ...
                <View key={m.key} style={{ flex: 1, backgroundColor: '#f1f5f9', borderRadius: 14, padding: 12 }}>
                  ...
                  <Text style={{ fontSize: 20, fontFamily: 'Inter_900Black', color: MACRO_COLORS[m.key as keyof typeof MACRO_COLORS], letterSpacing: -0.5 }}>
                    {m.value}
                  </Text>
          ...
          {data.mealPlan ? (
            ...
            <View style={{ backgroundColor: '#eff6ff', borderWidth: 1, borderColor: '#bfdbfe', borderRadius: 16, padding: 16 }}>
              ...
              <Text style={{ fontSize: 13, fontFamily: 'Inter_400Regular', color: '#3b82f6' }}>
                Completa tu perfil alimenticio para recibir comidas específicas y suplementación.
              </Text>
            </View>
          )}
        </>
